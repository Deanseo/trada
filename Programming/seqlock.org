...
* Table of Contents
- [[#what-is-seqlock][What is SeqLock and how it works]]
  - [[#how-seqlock-works][How it works]]
  - [[#actual-code-of-seqlock][Actual code]]
- [[#why-use-seqlock-over-mutex][Why use Seqlock over Mutex]]
  - [[#why-use-seqlock-over-mutex-short-answer][Short Answer]]
  - [[#why-use-seqlock-over-mutex-long-answer][Long Answer]]
  
* What is SeqLock and how it works
:PROPERTIES:
:CUSTOM_ID: what-is-seqlock
:END:
...
** Actual code
:PROPERTIES:
:CUSTOM_ID: actual-code-of-seqlock
:END:
...
*** Short Answer
:PROPERTIES:
:CUSTOM_ID: why-use-seqlock-over-mutex-short-answer
:END:
...
*** Long Answer
:PROPERTIES:
:CUSTOM_ID: why-use-seqlock-over-mutex-long-answer
:END:
